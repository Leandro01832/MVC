    ...
    public partial class Form_celula : Form
    {
        ...
        private void Form_celula_Load(object sender, EventArgs e)
        {
            ...
            if (cel.Cel_nome == null || cel.Lider == null || cel.Lider_treinamento == null
                || cel.Dia_semana == null || cel.Endereco_Celula.Cel_numero == 0 || cel.Endereco_Celula.Cel_bairro == null
                || cel.Endereco_Celula.Cel_rua == null)
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            cel.Horario = TimeSpan.Parse(mask_horario.ToString());
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            cel.Lidertreinamento_ = int.Parse(text_lider_treinamento.Text);
            cel.Dia_semana = list_dia_semana.Text;
            cel.Horario = TimeSpan.Parse(mask_horario.Text.ToString());
        ...
        private void text_numero_TextChanged(object sender, EventArgs e)
        {
            if(text_numero.Text == "")
            {
                cel.Endereco_Celula.Cel_numero = 0;
