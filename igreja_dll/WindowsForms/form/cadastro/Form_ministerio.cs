...
namespace igreja2.form.cadastro
{
    public partial class Form_ministerio : Form
    {
        ...
        Reuniao crono = new Reuniao();

        private void button1_Click(object sender, EventArgs e)
        {
            Ministerio minis = new Ministerio();
            minis.lider_ministerio = int.Parse(text_lider.Text);
            minis.Nome = text_nome.Text;
            minis.Proposito = text_proposito.Text;
            minis.salvar();
        ...
        {         
            ...
            if(minis.Nome == null || minis.Lider == null || minis.Proposito == null)
            {
